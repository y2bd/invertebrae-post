...
const App: React.FC = () => {
  ...
  const pushNewChapter = React.useCallback(
    (chapterName: string) => {
  ...
  return (
    <Store>
      <div className="App">
        <audio
          ref={audioRef}
          src={playBefore ? "before.mp3" : "timeremaining.mp3"}
          loop
          autoPlay
        />
        <Frame>
          <div className="Navigation">
            ...
            <span className={"HelpButton"} onClick={onHelp}>
              {"?"}
            </span>
          </div>
          ...
          {Object.keys(chapterGraph).map(chapterName => (
            <div
              ...
              style={{
                display:
                  chapterName === currentChapter.chapterName ? "flex" : "none",
            ...
            >
              ...
              >
                <Prompt
                  ...
                  solutions={story.chapters[chapterName].solutions}
                  onAccept={pushNewChapter}
                />
              </Chapter>
            </div>
          ))}
          {showHelp && (
            <div className="Help">
              {showHuh ? (
                <>
                  <p>
                    drag bold words from the story to the word bank on the
                    right.
                  </p>
                  <p>
                    drag (or double-click) words from the word bank to the
                    prompt at the bottom.
                  </p>
                  <p>
                    if you've found a valid answer, you'll see the OK button
                    light up.
                  </p>
                ...
                <>
                  <p>
                    welcome into <em>invertebrae</em>.
                  </p>
                  <p>
                    while life may progress along with currency, you as an
                    observer do not.
                  </p>
                  <p>
                    to the right stores knowledge, and below submits answers.
                  </p>
              ...
              <div className="Buttons">
                <span className="CloseHelp" onClick={onHuh}>
                  {showHuh ? "OH OK" : "HUH?"}
                </span>
                <span className="CloseHelp" onClick={onCloseHelp}>
                  I'LL TRY
                </span>
              </div>
            </div>
